...
public class loseScreenHard  implements Screen {
    private angryBirds game;
    private Stage stage;
    private Sound clickSound;
    private Texture winMenuTexture,  resetBtnTexture,menuBtnTexture;
    public loseScreenHard(angryBirds game) {
        this.game = game;

        // Load assets
        winMenuTexture = new Texture("loseScreen/levelFail.png");
        ...
        ImageButton resetButton = createButton(resetBtnTexture,555 , 240);
        ImageButton menuButton = createButton(menuBtnTexture,375 , 240);
